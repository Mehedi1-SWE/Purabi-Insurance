...
export default function Blogs() {
    return (
        <div className="min-h-[900px] bg-[#faf8f7] font-['Poppins'] text-[#111]">
            ...
            {/* Banner */}
            <section className="relative overflow-hidden bg-[#f6f1ee] px-[80px] py-[82px] text-[#171313]">
                ...
                <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(248,245,243,0.99)_0%,rgba(248,245,243,0.96)_32%,rgba(248,245,243,0.78)_50%,rgba(248,245,243,0.30)_72%,rgba(248,245,243,0.08)_100%)]" />
                ...
                <div className="relative mx-auto w-[1280px]">
                    ...
                    <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#ac3e25]/15 bg-white/70 px-3 py-1.5 shadow-[0_4px_14px_rgba(80,45,35,.06)] backdrop-blur-sm">
                    ...
                    <h1 className="text-[54px] font-semibold leading-[1.05] tracking-[-1.2px] text-[#211a18]">
                        Insurance, explained better.
                    </h1>

                    <p className="mt-6 max-w-[650px] text-[17px] leading-[1.7] text-[#5f5753]">
