    ...
    return (
        <div className="min-h-[900px] bg-[#faf8f7] font-['Poppins'] text-[#111]">
            ...
            <section className="relative overflow-hidden bg-[#111] px-[80px] py-[82px] text-white">
                ...
                {/* IMPORTANT: actual file is blogs-banner.png */}
                <img
                ...
                <div className="relative mx-auto w-[1280px]">
                    <p className="text-[13px] font-medium uppercase tracking-[2px] text-[#d9785f]">
                        Insights & updates
                    </p>
                    ...
                    <p className="mt-6 max-w-[650px] text-[17px] leading-[1.7] text-white/70">
                        ...
                        >
                            ...
                            <div className="p-7">
                                ...
                                <div className="flex items-center justify-between gap-3 text-[11px] text-[#ac3e25]">
                                    <span>{post.date}</span>
                                    <span className="text-[#999]">{post.readTime}</span>
                                </div>
